                ...
                <div class="row" style="margin-top: 45px;">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control" name="phone" value="{{ old('phone') }}" maxlength="11" minlength="6" required>
                        ...
                        <div class="form-group{{ $errors->has('addr') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="addr" type="text" class="form-control" name="addr" required></textarea>
                                @if ($errors->has('addr'))
                                    <span class="help-block">
                        ...
                        <input type="hidden" name="role" id="role" value="CST">
